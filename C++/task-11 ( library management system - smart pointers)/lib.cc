...
int main()
{
    ...
    library.addBook(std::make_unique<Book>("book1", "Mohamed", "1111", true));
    library.addBook(std::make_unique<Book>("book2", "Samer", "1112", true));
    library.addUser(std::make_unique<Student>("mohamed", "253335"));
    library.addUser(std::make_unique<Student>("jason", "251086"));
    library.addUser(std::make_unique<Teacher>("amgad", "1234"));
    library.addUser(std::make_unique<Engineer>("anas", "1259"));
